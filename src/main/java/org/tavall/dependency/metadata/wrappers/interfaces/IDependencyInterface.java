...
package org.tavall.dependency.metadata.wrappers.interfaces;
 ...
 */
public interface IDependencyInterface<INTERFACE> extends IDependencyAccess {
    ...
    private void validateInterfaceType(Class<?> interfaceType) {
        if (interfaceType == null) {
            throw new IllegalArgumentException("[DependencyInterface] dependency token is required");
        }
    }
