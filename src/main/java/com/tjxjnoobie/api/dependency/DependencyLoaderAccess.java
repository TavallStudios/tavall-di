...
public final class DependencyLoaderAccess {
    ...
    public static <T> Optional<T> findOptionalInstance(Class<T> dependencyType) {
        return Optional.ofNullable(findInstance(dependencyType));
    }
    ...
    public static <T> Optional<T> findOptionalInstance(String scopeName, Class<T> dependencyType) {
        return Optional.ofNullable(findInstance(scopeName, dependencyType));
    }
    ...
    /**
     * Clears the default dependency scope.
     */
    ...
    /**
     * Clears the named dependency scope.
     *
     * @param scopeName the DI scope to clear
     */
    public static void clear(String scopeName) {
        loader(scopeName).clear();
    }
}
