# Contributing to tavall-di

This repository is the canonical standalone source of truth for `tavall-di`.

## Development workflow

1. Clone or fetch this repository:
   ```bash
   git clone https://github.com/TavallStudios/tavall-di.git
   ```
